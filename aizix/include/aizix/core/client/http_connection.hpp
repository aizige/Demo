...
#ifndef AIZIX_HTTP_CONNECTION_HPP
#define AIZIX_HTTP_CONNECTION_HPP
...
private:
    ...
    /// @brief 上次PING的时间点
    /// 由 HttpClientPoolHttpClientPool 的后台维护任务使用，以判断连接多久没ping过了
    std::chrono::steady_clock::time_point last_ping_timestamp_ms_;
};

#endif //AIZIX_HTTP_CONNECTION_HPP
