...
#include <aizix/http/http_common_types.hpp> // 包含 RouteMatch, HandlerFunc 等
...
// --- 路由注册实现 ---
void Router::add_route(const http::verb method, std::string_view path, HandlerFunc handler) {
